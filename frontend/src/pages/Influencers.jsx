              ...
              <div className="sm:flex sm:items-center">
                <div className="sm:flex-auto">
                  ...
                  <p className="mt-2 text-sm text-gray-700">
                    Encuentra y conecta con influencers para colaboraciones.
                  </p>
                </div>
              ...
              <div className="mt-8">
                {influencers.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="mt-2 text-sm font-medium text-gray-900">No hay influencers</h3>
                    <p className="mt-1 text-sm text-gray-500">
                      Comienza buscando influencers para colaboraciones.
                    </p>
                    <div className="mt-6">
                      <button
                        type="button"
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {/* Aquí irían las tarjetas de influencers */}
                  </div>
                )}
              </div>
            </div>
